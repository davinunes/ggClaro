...
<div class="row">
    <form class="col s12" id="formService">
      <div class="row">
        ...
        <div class="input-field col s12 m6">
          <input id="ServiceDefVal" name="ServiceDefVal" placeholder="1.15" step=".01" pattern="^\d+(?:\.\d{1,2})?$" onblur="this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'inherit':'red'" type="number" class="decimal validate ">
